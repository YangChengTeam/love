package com.yc.verbaltalk.skill.model.bean;
...
public class ChatCheatsInfo implements Serializable, MultiItemEntity {
    ...
    public static final int VIEW_FEED_AD = 4;//头条原生广告

    public TTNativeExpressAd expressAdView;

    public ChatCheatsInfo() {
    }

    public ChatCheatsInfo(String name, int type) {
        this.name = name;
        this.type = type;
    }

    public ChatCheatsInfo(String name, int type, int canShouCount) {
        this.name = name;
        this.type = type;
        this.canShouCount = canShouCount;
    }

    public ChatCheatsInfo(int type, int create_time, int id, String image, String post_title) {
        this.type = type;
