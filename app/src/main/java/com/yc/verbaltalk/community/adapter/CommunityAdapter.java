...
//        Log.e(TAG, "convert: " + helper.getAdapterPosition() + " --" + item.is_dig);
        ...
        if (null != commentInfo && !TextUtils.isEmpty(commentInfo.name) && !TextUtils.isEmpty(commentInfo.content)) {
//            Log.e(TAG, "convert: " + JSON.toJSONString(commentInfo));
            helper.setGone(R.id.ll_comment, true);
            String comment = "<font color='#000000'>" + commentInfo.name + "：</font>" + commentInfo.content;
