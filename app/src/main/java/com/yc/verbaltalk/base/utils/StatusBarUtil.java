...
import com.yc.verbaltalk.base.view.imgs.AndroidRomUtil;
...
public class StatusBarUtil {
    ...
    public static boolean isMIUI() {
        try {
            final AndroidRomUtil.BuildProperties prop = AndroidRomUtil.BuildProperties.newInstance();
...
//                attributes.flags |= flagTranslucentNavigation;
        ...
        if (activity instanceof AppCompatActivity) {
            AppCompatActivity aa = (AppCompatActivity) activity;
            if (null != aa.getSupportActionBar()) {
                aa.getSupportActionBar().hide();
            }
        }
    }

    private static int getStatusColor() {
        return mColor;
    }

    private static int mColor = Color.TRANSPARENT;

    public static void setStatusColor(int color) {
        mColor = color;
    }
...
// check override flag
            ...
            return !ViewConfiguration.get(context).hasPermanentMenuKey() && !KeyCharacterMap
