...
import com.yc.verbaltalk.adaper.rv.CommunityMainAdapter;
import com.yc.verbaltalk.ui.activity.CommunityNoticeDetailActivity;
import com.yc.verbaltalk.ui.activity.CommunityPublishActivity;
...
public class CommunityMainFragment extends BaseMainFragment implements View.OnClickListener {
    ...
    private void netSwitchPagerData() {
        ...
        CommunityMainAdapter communityMainAdapter = new CommunityMainAdapter(getChildFragmentManager(), titleList);
