...
//            Toast.makeText(WXEntryActivity1.this, transaction, Toast.LENGTH_SHORT).show();
                    ...
                    if (transaction.contains("workShare")) {
                        ...
                        //正确返回
//                        Toast.makeText(WXEntryActivity1.this, "微信分享--成功", Toast.LENGTH_SHORT).show();
                    }
                }
                break;
            case BaseResp.ErrCode.ERR_USER_CANCEL:
                //用户取消
                Toast.makeText(WXEntryActivity1.this, "微信:用户取消", Toast.LENGTH_SHORT).show();
                break;
            case BaseResp.ErrCode.ERR_AUTH_DENIED:
                //认证被否决
                Toast.makeText(WXEntryActivity1.this, "微信:认证被否决", Toast.LENGTH_SHORT).show();
                break;
            case BaseResp.ErrCode.ERR_SENT_FAILED:
                //发送失败
                Toast.makeText(WXEntryActivity1.this, "微信:发送失败", Toast.LENGTH_SHORT).show();
                break;
            case BaseResp.ErrCode.ERR_UNSUPPORT:
                //不支持错误
                Toast.makeText(WXEntryActivity1.this, "微信:不支持错误", Toast.LENGTH_SHORT).show();
                break;
            case BaseResp.ErrCode.ERR_COMM:
                //一般错误
                Toast.makeText(WXEntryActivity1.this, "微信:一般错误", Toast.LENGTH_SHORT).show();
                break;
            default:
                //其他不可名状的情况
                break;
