...
public class LoveHealTitleViewHolder extends BaseViewHolder<LoveHealBean> {
    ...
    public LoveHealTitleViewHolder(Context context, RecyclerViewItemListener listener, ViewGroup parent) {
        super(context, parent, R.layout.recycler_view_item_love_heal_title, listener);   //一个类对应一个布局文件
    }

    @Override
    public void bindData(LoveHealBean loveHealBean) {

        TextView tvName = itemView.findViewById(R.id.item_love_heal_title_tv_name);
