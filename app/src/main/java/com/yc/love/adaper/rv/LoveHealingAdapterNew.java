...
public class LoveHealingAdapterNew extends BaseMultiItemQuickAdapter<LoveHealingBean, BaseViewHolder> {
     ...
     */
    public LoveHealingAdapterNew(List<LoveHealingBean> data) {
        super(data);
