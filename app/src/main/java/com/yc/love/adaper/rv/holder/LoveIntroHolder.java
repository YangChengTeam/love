...
public class LoveIntroHolder extends BaseViewHolder<ExampListsBean> {
    ...
    public LoveIntroHolder(Context context, RecyclerViewItemListener listener, ViewGroup parent) {
        super(context, parent, R.layout.recycler_view_item_love_intro, listener);   //一个类对应一个布局文件
        this.context = context;
    }

    @Override
    public void bindData(ExampListsBean exampListsBean) {
        TextView tvName = itemView.findViewById(R.id.love_intro_tv_name);
        TextView tvDes = itemView.findViewById(R.id.love_intro_tv_des);
        ImageView ivIcon = itemView.findViewById(R.id.love_intro_iv_icon);
