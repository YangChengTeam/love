...
public class LoveHealDetAdapterNew extends BaseMultiItemQuickAdapter<LoveHealDetDetailsBean, BaseViewHolder> {
     ...
     */
    public LoveHealDetAdapterNew(List<LoveHealDetDetailsBean> data) {
        super(data);
