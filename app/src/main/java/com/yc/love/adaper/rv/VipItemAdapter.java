...
public class VipItemAdapter extends BaseQuickAdapter<IndexDoodsBean, BaseViewHolder> {
    ...
    protected void convert(BaseViewHolder helper, IndexDoodsBean item) {
        ...
        constraintLayoutSparseArray.put(position, (ConstraintLayout) helper.getView(R.id.item_become_vip_tail_cl_con_01));
        payUnitSparseArray.put(position, (TextView) helper.getView(R.id.item_become_vip_tail_tv_pay_unit_01));
        payMonSparseArray.put(position, (TextView) helper.getView(R.id.item_become_vip_tail_tv_pay_mon_01));
        descSparseArray.put(position, (TextView) helper.getView(R.id.item_become_vip_tail_tv_pay_des_01));
        imageViewSparseArray.put(position, (ImageView) helper.getView(R.id.item_become_vip_tail_iv_pay_sel_01));
