...
public abstract class BaseLoadMoreClickItemAdapter<T> extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public BaseLoadMoreClickItemAdapter(List<T> personList, RecyclerView recyclerView) {
    ...
    private RecyclerView.OnScrollListener onScrollListener = new RecyclerView.OnScrollListener() {
        ...
        public void onScrolled(RecyclerView recyclerView, int dx, int dy) {
            ...
            Log.d("ssss", "onScrolled: " + "firstVisibleItemPosition 可见的第一条 111 =" + firstVisibleItemPosition);
