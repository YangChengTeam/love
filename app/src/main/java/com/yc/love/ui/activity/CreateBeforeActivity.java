...
import com.yc.love.model.util.ScreenUtils;
import com.yc.love.model.util.SizeUtils;
...
import com.yc.love.ui.view.CustomProgress;
...
public class CreateBeforeActivity extends BaseSameActivity implements INormalUiView, IUpFileUiView {
...
//        mDataUrl = URLConfig.CATEGORY_LIST_URL;
    ...
    private void initData() {
        ...
        if (mConfessionDataBean != null) {
            Glide.with(this).load(mConfessionDataBean.front_img).asBitmap().into(new SimpleTarget<Bitmap>() {
                @Override
