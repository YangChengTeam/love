...
//    private TextView tv_look;
    ...
    public void instanceDialog(final Context context) {
        ...
        TextView tv_album = (TextView) window.findViewById(R.id.dialog_select_photo_tv_album);
        TextView tv_camera = (TextView) window.findViewById(R.id.dialog_select_photo_tv_camera);
        TextView tv_cancel = (TextView) window.findViewById(R.id.dialog_select_photo_tv_cancel);
    ...
    private View.OnClickListener clickAlbum = new View.OnClickListener() {
        @Override
        public void onClick(View view) {
            clickAlbum();
        }
    };
    private View.OnClickListener clickCamera = new View.OnClickListener() {
        @Override
        public void onClick(View view) {
            clickCamera();
        }
